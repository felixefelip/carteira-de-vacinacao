...
class User::Record
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::User::Record).void)).returns(::User::Record) }
    sig do
      params(
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::User::Record).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `User::Record` class because it declared `has_many :recomendacao_vacinas`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
