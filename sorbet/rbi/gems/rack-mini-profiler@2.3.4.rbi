...
class PG::Connection
  ...
  # source://pg/1.5.8/lib/pg/connection.rb#387
  def check_socket; end

  def client_encoding=(_arg0); end
  def close; end

  # source://pg/1.5.8/lib/pg/connection.rb#329
  def conndefaults; end

  # source://pg/1.5.8/lib/pg/connection.rb#345
  ...
  # source://pg/1.5.8/lib/pg/connection.rb#353
  def conninfo_hash; end

  def consume_input; end

  # source://pg/1.5.8/lib/pg/connection.rb#214
  ...
  # source://pg/1.5.8/lib/pg/connection.rb#100
  def inspect; end
  ...
  # source://pg/1.5.8/lib/pg/connection.rb#370
  ...
  # source://pg/1.5.8/lib/pg/connection.rb#308
  def transaction; end
  ...
  # source://pg/1.5.8/lib/pg/connection.rb#652
  ...
  class << self
    # source://pg/1.5.8/lib/pg/connection.rb#959
    def async_api=(enable); end

    # source://pg/1.5.8/lib/pg/connection.rb#773
    def async_connect(*args); end

    # source://pg/1.5.8/lib/pg/connection.rb#880
    def async_ping(*args); end

    # source://pg/1.5.8/lib/pg/connection.rb#936
    def async_send_api=(enable); end

    def conndefaults; end

    # source://pg/1.5.8/lib/pg/connection.rb#337
    def conndefaults_hash; end

    # source://pg/1.5.8/lib/pg/connection.rb#773
    def connect(*args); end

    # source://pg/1.5.8/lib/pg/connection.rb#44
    ...
    # source://pg/1.5.8/lib/pg/connection.rb#64
    def parse_connect_args(*args); end

    # source://pg/1.5.8/lib/pg/connection.rb#880
    def ping(*args); end

    # source://pg/1.5.8/lib/pg/connection.rb#37
    ...
    # source://pg/1.5.8/lib/pg/connection.rb#825
    def connect_to_hosts(*args); end

    # source://pg/1.5.8/lib/pg/connection.rb#850
    def host_is_named_pipe?(host_string); end

    # source://pg/1.5.8/lib/pg/connection.rb#794
...
class PG::Result
  ...
  # source://pg/1.5.8/lib/pg/result.rb#26
  ...
  # source://pg/1.5.8/lib/pg/result.rb#32
  def inspect; end

  # source://pg/1.5.8/lib/pg/result.rb#16
