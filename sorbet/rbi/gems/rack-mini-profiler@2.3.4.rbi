...
class PG::Connection
  ...
  # source://pg/1.3.3/lib/pg/connection.rb#327
  def conndefaults; end

  # source://pg/1.3.3/lib/pg/connection.rb#343
  ...
  # source://pg/1.3.3/lib/pg/connection.rb#351
  def conninfo_hash; end

  def consume_input; end

  # source://pg/1.3.3/lib/pg/connection.rb#243
  ...
  # source://pg/1.3.3/lib/pg/connection.rb#368
  ...
  # source://pg/1.3.3/lib/pg/connection.rb#312
  def transaction; end
  ...
  # source://pg/1.3.3/lib/pg/connection.rb#614
  def async_connect_or_reset(poll_meth); end

  def flush_data=(_arg0); end

  class << self
    # source://pg/1.3.3/lib/pg/connection.rb#807
    def async_api=(enable); end

    # source://pg/1.3.3/lib/pg/connection.rb#700
    def async_connect(*args, **kwargs); end

    # source://pg/1.3.3/lib/pg/connection.rb#732
    def async_ping(*args); end

    # source://pg/1.3.3/lib/pg/connection.rb#784
    def async_send_api=(enable); end

    def conndefaults; end

    # source://pg/1.3.3/lib/pg/connection.rb#335
    def conndefaults_hash; end

    # source://pg/1.3.3/lib/pg/connection.rb#700
    def connect(*args, **kwargs); end

    # source://pg/1.3.3/lib/pg/connection.rb#45
    def connect_hash_to_string(hash); end

    def connect_start(*_arg0); end

    # source://pg/1.3.3/lib/pg/connection.rb#52
    ...
    # source://pg/1.3.3/lib/pg/connection.rb#93
    def parse_connect_args(*args); end

    # source://pg/1.3.3/lib/pg/connection.rb#732
    def ping(*args); end

    # source://pg/1.3.3/lib/pg/connection.rb#38
...
class PG::Result
  ...
  # source://pg/1.3.3/lib/pg/result.rb#26
  ...
  # source://pg/1.3.3/lib/pg/result.rb#32
  def inspect; end

  # source://pg/1.3.3/lib/pg/result.rb#16
