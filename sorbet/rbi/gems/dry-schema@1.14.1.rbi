...
class Dry::Schema::DSL
  ...
  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#151
  def meta(key_name, meta_key, value); end

  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#163
  def meta_data; end
...
class Dry::Schema::Macros::Hash < ::Dry::Schema::Macros::Schema
  # @api private
  #
  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#85
  def call(&block); end

  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#64
  def description(text); end

  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#73
...
class Dry::Schema::Macros::Optional < ::Dry::Schema::Macros::Key
  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#47
  def description(text); end

  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#54
  def hidden(hidden = T.unsafe(nil)); end
...
class Dry::Schema::Macros::Required < ::Dry::Schema::Macros::Key
  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#30
  def description(text); end

  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#37
  def hidden(hidden = T.unsafe(nil)); end
...
class Dry::Schema::Macros::Value < ::Dry::Schema::Macros::DSL
  ...
  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#13
  def description(text); end
  ...
  # source://fast-mcp/1.6.0/lib/mcp/tool.rb#20
  def hidden(hidden = T.unsafe(nil)); end
