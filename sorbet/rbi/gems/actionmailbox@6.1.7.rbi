...
class ActionMailbox::InboundEmail < ::ActionMailbox::Record
  ...
  class << self
    ...
    # source://activerecord/6.1.7/lib/active_record/enum.rb#174
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  ...
  # source://activestorage/6.1.7/lib/active_storage/attached/model.rb#55
  def raw_email; end

  # source://activestorage/6.1.7/lib/active_storage/attached/model.rb#60
