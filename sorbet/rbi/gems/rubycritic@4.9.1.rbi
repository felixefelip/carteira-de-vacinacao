...
module RubyCritic::Config
  class << self
    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#69
    def build_mode?; end

    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#65
    def compare_branches_mode?; end

    # source://rubycritic//lib/rubycritic/configuration.rb#57
    def configuration; end

    # source://rubycritic//lib/rubycritic/configuration.rb#73
    def method_missing(method, *args, &block); end

    # @return [Boolean]
    #
    # source://rubycritic//lib/rubycritic/configuration.rb#81
    def respond_to_missing?(symbol, include_all = T.unsafe(nil)); end

    # source://rubycritic//lib/rubycritic/configuration.rb#61
...
class RubyCritic::Configuration
  ...
  # source://rubycritic//lib/rubycritic/configuration.rb#46
  def root=(path); end
  ...
  # source://rubycritic//lib/rubycritic/configuration.rb#29
  def setup_analysis_targets(options); end

  # source://rubycritic//lib/rubycritic/configuration.rb#40
