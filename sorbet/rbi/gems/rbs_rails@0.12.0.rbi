...
class RbsRails::ActiveRecord::Generator
  ...
  #
  # source://rbs_rails//lib/rbs_rails/active_record.rb#17
  def initialize(klass, dependencies:); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#26
  def generate; end

  private

  # source://rbs_rails//lib/rbs_rails/active_record.rb#432
  def args_to_type(args_node); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#117
  def associations; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#160
  def belongs_to; end
  ...
  #
  # source://rbs_rails//lib/rbs_rails/active_record.rb#359
  def build_enum_definitions; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#83
  def collection_proxy_decl; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#487
  def columns; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#249
  def delegated_type_definitions; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#228
  def delegated_type_instance; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#217
  def delegated_type_scope(singleton:); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#352
  def enum_definitions; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#318
  def enum_instance_methods; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#380
  def enum_method_name(hash, name, label); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#336
  def enum_scope_methods(singleton:); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#113
  def footer; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#182
  def generated_association_methods; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#63
  def generated_relation_methods_decl; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#125
  def has_many; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#143
  def has_one; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#288
  def has_secure_password; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#92
  def header; end

  # Returns the value of attribute klass.
  #
  # source://rbs_rails//lib/rbs_rails/active_record.rb#558
  def klass; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#30
  def klass_decl; end
  ...
  # source://rbs_rails//lib/rbs_rails/active_record.rb#460
  def parse_model_file; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#55
  def pk_type; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#483
  def relation_class_name; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#73
  def relation_decl; end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#398
  def scopes(singleton:); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#529
  def sql_type_to_class(t); end

  # source://rbs_rails//lib/rbs_rails/active_record.rb#473
  def traverse(node, &block); end
end

# source://rbs_rails//lib/rbs_rails/active_record.rb#15
RbsRails::ActiveRecord::Generator::IGNORED_ENUM_KEYS = T.let(T.unsafe(nil), Array)
