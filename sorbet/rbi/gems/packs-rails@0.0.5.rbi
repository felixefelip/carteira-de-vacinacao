...
module Packs
  class << self
    # source://packs/0.0.44/lib/packs.rb#146
    ...
    # source://packs/0.0.44/lib/packs.rb#261
    sig { void }
    def bust_cache!; end

    # source://packs/0.0.44/lib/packs.rb#52
    sig { params(files: T::Array[::String]).returns(T::Boolean) }
    def check(files); end

    # source://packs/0.0.44/lib/packs/configuration.rb#54
    sig { returns(::Packs::Configuration) }
    def config; end

    # source://packs/0.0.44/lib/packs/configuration.rb#61
    sig { params(blk: T.proc.params(arg0: ::Packs::Configuration).void).void }
    def configure(&blk); end

    # source://packs/0.0.44/lib/packs.rb#69
    sig do
      params(
        pack_name: ::String,
    ...
    # source://packs/0.0.44/lib/packs.rb#203
    sig do
      params(
        pack_name: ::String,
        destination: ::String,
    ...
    # source://packs/0.0.44/lib/packs.rb#92
    sig do
      params(
        pack_name: ::String,
        paths_relative_to_root: T::Array[::String],
    ...
    # source://packs/0.0.44/lib/packs.rb#173
    sig do
      params(
        pack_name: ::String,
        parent_name: ::String,
