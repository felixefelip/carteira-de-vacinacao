...
module Packs
  class << self
    ...
    # source://packs//lib/packs/configuration.rb#54
    sig { returns(::Packs::Configuration) }
    def config; end

    # @yield [config]
    #
    # source://packs//lib/packs/configuration.rb#61
...
class Packs::Configuration
  ...
  # source://packs//lib/packs/configuration.rb#40
  sig { void }
  def bust_cache!; end

  # source://packs//lib/packs/configuration.rb#45
  sig { returns(T::Boolean) }
  def default_enforce_dependencies; end

  # source://packs//lib/packs/configuration.rb#35
  sig { returns(T::Boolean) }
...
# source://packs//lib/packs/configuration.rb#19
...
class Packs::Private::FileMoveOperation < ::T::Struct
  ...
  # source://packs//lib/packs/private/file_move_operation.rb#75
