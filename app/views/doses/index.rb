  ...
  class Index < Views::Base
    ...
    def view_template
      ...
      table do
        ...
        link_to 'Nova Vacina', helpers.new_vacina_path
      end
    end
    ...
    sig { params(vacina: Vacina::Record).returns(String) }
    def table_row_vacina(vacina)
      tr do
        td { vacina.descricao }
        td { link_to 'Show', vacina }
        td { link_to 'Edit', helpers.edit_vacina_path(vacina) }
        td { link_to 'Cadastrar dose', helpers.new_vacina_dose_path(vacina) }
